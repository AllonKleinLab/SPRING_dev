      ...
      var s = (e.Bounds = (function() {
        ...
        (e.parseBoundCurves = function(A, e, t) {
          ...
          return {
            ...
            topRightOuter:
              a > 0 || s > 0 ? c(A.left + g, A.top, a, s, i.TOP_RIGHT) : new n.default(A.left + A.width, A.top),
            topRightInner:
              a > 0 || s > 0
                ? c(
            ...
            bottomLeftOuter:
              u > 0 || Q > 0 ? c(A.left, A.top + F, u, Q, i.BOTTOM_LEFT) : new n.default(A.left, A.top + A.height),
            bottomLeftInner:
              u > 0 || Q > 0
                ? c(
                    A.left + e[3].borderWidth,
            ...
            'IMG' === e.tagName &&
              e.addEventListener('load', function() {
                (y.bounds = (0, K.parseBounds)(e, L, _)),
                  (y.curvedBounds = (0, K.parseBoundCurves)(y.bounds, y.style.border, y.style.borderRadius));
              }),
              (this.image = b(e, r)),
              (this.bounds = O ? (0, T.reformatInputBounds)((0, K.parseBounds)(e, L, _)) : (0, K.parseBounds)(e, L, _)),
              (this.curvedBounds = (0, K.parseBoundCurves)(this.bounds, this.style.border, this.style.borderRadius));
          }
          return (
            r(A, [
              {
                ...
                value: function() {
                  ...
                  return this.style.overflow !== g.OVERFLOW.VISIBLE
                    ? A.concat([(0, K.calculatePaddingBoxPath)(this.curvedBounds)])
                    : A;
                },
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  return (
                    ...
                    (0, B.contains)(this.style.display, i.DISPLAY.INLINE_BLOCK) ||
                    (0, B.contains)(this.style.display, i.DISPLAY.INLINE_FLEX) ||
                    (0, B.contains)(this.style.display, i.DISPLAY.INLINE_GRID) ||
                    (0, B.contains)(this.style.display, i.DISPLAY.INLINE_LIST_ITEM) ||
                      ...
                      (0, r.loadSerializedSVG)(s)
                        .then(function(e) {
                          ...
                          return (
                            ...
                            n(B)
                              ? (0, r.loadSerializedSVG)((0, r.createForeignObjectSVG)(100, 100, 0, 0, s))
                              : Promise.reject(!1)
                          );
                        })
                        .then(function(A) {
          ...
          if (s) {
            ...
            if (u)
              ...
              'number' == typeof e.listIndex &&
                ((c = A.ownerDocument.createTextNode(F(e.listIndex, s.listStyleType, !0))),
                i.appendChild(c),
                (i.style.top = e.bounds.top - l + 'px'));
          ...
          for (
            var r =
                0 !== e.style.letterSpacing
                  ...
                  : (0, a.breakWords)(A, e),
              c = r.length,
              l = t.parentNode ? t.parentNode.ownerDocument.defaultView : null,
              u = l ? l.pageXOffset : 0,
              Q = l ? l.pageYOffset : 0,
              w = [],
              U = 0,
          ...
          d =
            e === w.documentElement
              ...
              : t.backgroundColor
                ? new u.default(t.backgroundColor)
                : null;
        return (t.foreignObjectRendering ? s.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(
          s,
        ) {
          return s
            ? (function(A) {
            ...
            : (0, i.cloneWindow)(w, U, e, t, Q, A).then(function(A) {
                ...
                return (
                  d === u.container.style.background.backgroundColor &&
                    (u.container.style.background.backgroundColor = l.TRANSPARENT),
                  ...
                  'INPUT' === g.tagName
                    ...
                    : 'TEXTAREA' === g.tagName
                      ...
                      : 'SELECT' === g.tagName
                        ...
                        : d.style.listStyle &&
                          d.style.listStyle.listStyleType !== o.LIST_STYLE_TYPE.NONE &&
      ...
      e.parseTextShadow = function(A) {
        ...
        for (
          var e = '',
            ...
            c = function() {
              B.length && null !== o && a.push({ color: o, offsetX: B[0] || 0, offsetY: B[1] || 0, blur: B[2] || 0 }),
                B.splice(0, B.length),
                (o = null);
            },
            l = 0;
    ...
    function(A, e, t) {
      ...
      var o = (e.LETTER_NUMBER_MODIFIER = 50),
        ...
        G = function(A, e, t, r, n) {
          ...
          if (
            (-1 !== [E, f].indexOf(o) && (b === F || (-1 !== [C, l].indexOf(b) && e[s + 1] === F))) ||
            (-1 !== [C, l].indexOf(o) && b === F) ||
      ...
      var l = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
        ...
        h = function(A, e, t) {
          var r = (0, n.parseAngle)(A[0]),
            ...
            s = a ? (null !== r ? p(t ? r - 0.5 * Math.PI : r, e) : B ? I(A[0], e) : K(A[0], e)) : p(Math.PI, e),
            i = a ? 1 : 0,
            c = Math.min(
        ...
        T = function(A, e, t, r) {
          return [{ x: 0, y: 0 }, { x: 0, y: A.height }, { x: A.width, y: 0 }, { x: A.width, y: A.height }].reduce(
            function(A, n) {
        ...
        m = function(A, e, t, r, n) {
          ...
          switch (A) {
            case 'closest-side':
              e === C.CIRCLE
                ? (s = i = Math.min(Math.abs(B), Math.abs(B - n.width), Math.abs(a), Math.abs(a - n.height)))
                : e === C.ELLIPSE &&
            ...
            case 'farthest-side':
              e === C.CIRCLE
                ? (s = i = Math.max(Math.abs(B), Math.abs(B - n.width), Math.abs(a), Math.abs(a - n.height)))
                : e === C.ELLIPSE &&
                            ...
                            (B.onload = function() {
                              ...
                              r.parentNode &&
                                r.parentNode.replaceChild(
                                  (0, o.copyCSSStyles)(A.ownerDocument.defaultView.getComputedStyle(A), B),
                                  r,
                                );
                          });
                        })),
                ...
                value: function(A) {
                  ...
                  if (
                    ...
                    switch (
                      ...
                      !r || !this.copyStyles || A instanceof HTMLIFrameElement || (0, o.copyCSSStyles)(r, e),
                ...
                if (!U(A) || n.default.SUPPORT_SVG_DRAWING) {
                  ...
                  if (!this.isSameOrigin(A)) {
                    if ('string' == typeof this.options.proxy)
                      return (
                        (this.cache[A] = (0, B.Proxy)(A, this.options).then(function(A) {

define(["require", "exports", "d3", "./main"], function (require, exports, d3, main_1) {
    ...
    class Cluster2 {
        ...
        constructor() {
            ...
            d3.select('#cluster_popup').call(d3
                .drag()
        ...
        run_clustering() {
            if (main_1.forceLayout.mutable) {
                ...
                this.hide_popup();
                $.ajax({
                    data: { base_dir: main_1.graph_directory, sub_dir: main_1.project_directory, resolution: louvain_resolution },
                    success: data => {
                        let t1 = new Date();
                        ...
                        main_1.colorBar.loadData('categorical', true);
                        this.show_notification();
                    },
                    type: 'POST',

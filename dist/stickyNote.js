...
define(["require", "exports", "d3", "sweetalert", "./main"], function (require, exports, d3, sweetalert_1, main_1) {
    "use strict";
    ...
    class StickyNote {
        ...
        static create() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this._instance) {
                    ...
                    throw new Error('StickyNote.create() has already been called, get the existing instance with StickyNote.instance!');
                }
            });
        }
        constructor() {
            ...
            this.popup
                ...
                .style('width', '252px');
            d3.select('#stickyNote_popup').call(d3
                .drag()
        ...
        loadData() {
            return __awaiter(this, void 0, void 0, function* () {
                this.sticky_path = main_1.project_directory + '/sticky_notes_data.json';
                try {
                    yield $.get(this.sticky_path);
                    const data = yield d3.json(this.sticky_path);
                    data.forEach(d => {
                        this.new_note(d);
                    });
                }
        ...
        activate_note(note) {
            ...
            note
                ...
                if (d !== '') {
                    ...
                    main_1.forceLayout.all_outlines[d].selected = true;
                    main_1.forceLayout.all_outlines[d].tint = '0xffff00';
                    main_1.forceLayout.all_outlines[d].alpha = 1;
                }
            });
            main_1.colorBar.count_clusters();
            main_1.selectionScript.update_selected_count();
            main_1.colorBar.shrinkNodes(10, 10, my_nodes, main_1.forceLayout.all_nodes);
        }
        deactivate_all() {
        ...
        write_data() {
            ...
            const path = main_1.project_directory + '/sticky_notes_data.json';
            $.ajax({
                data: { path: path, content: JSON.stringify(all_data, null, ' ') },
                success: () => {
                    sweetalert_1.default({ title: 'All stickies have been saved' });
                },
                type: 'POST',

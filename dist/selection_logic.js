define(["require", "exports", "d3", "./main"], function (require, exports, d3, main_1) {
    ...
    class SelectionLogic {
        ...
        static create() {
            if (!this._instance) {
                ...
                throw new Error('SelectionLogic.create() has already been called, get the existing instance with SelectionLogic.instance!');
            }
        }
        constructor() {
            this.selection_data = {};
            ...
            d3.select('#selection_logic_popup').call(d3
                .drag()
        ...
        set_selections(sel) {
            ...
            for (let i = 0; i < sel.length; i++) {
                main_1.forceLayout.all_outlines[sel[i]].tint = '0xffff00';
                main_1.forceLayout.all_outlines[sel[i]].selected = true;
                main_1.forceLayout.all_outlines[sel[i]].alpha = main_1.forceLayout.all_nodes[sel[i]].alpha;
            }
    ...
    exports.default = SelectionLogic;
});

define(["require", "exports", "d3", "spinner", "./main"], function (require, exports, d3, Spinner, main_1) {
    ...
    exports.diffex_setup = () => {
        ...
        function open_diffex() {
            gene_list = Object.keys(main_1.colorBar.all_gene_color_array);
        ...
        function scatter_setup() {
            ...
            let yy = [];
            gene_list.forEach(d => {
                xx.push(masked_average(main_1.colorBar.all_gene_color_array[d], blue_selection));
                yy.push(masked_average(main_1.colorBar.all_gene_color_array[d], yellow_selection));
            });
            scatter_data = [];
            ...
            let mask_points = scatter_x(0).toString() +
                ',' +

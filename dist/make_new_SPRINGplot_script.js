define(["require", "exports", "d3", "./main"], function (require, exports, d3, main_1) {
    ...
    class SpringPlot {
        constructor() {
            this.hide_make_new_SPRINGplot_popup = () => {
            ...
            this.show_make_new_SPRINGplot_popup = () => {
            ...
            this.popup
                ...
                setTimeout(() => {
                    ...
                    if (d3.select('#make_new_SPRINGplot_message_div').style('visibility') === 'hidden') {
                        this.popup.style('height', d3.min([$('#newSPRING_description_box').height() + 597.223, STARTHEIGHT]).toString() + 'px');
                    }
                    else {
                        this.popup.style('height', d3.min([$('#newSPRING_description_box').height() + 745, MAXHEIGHT]).toString() + 'px');
                    }
                }, 0);
            });
            ...
            d3.select('#make_new_SPRINGplot_popup').call(d3
                .drag()
        ...
        static create() {
            if (!this._instance) {
                ...
                throw new Error('SpringPlot.create() has already been called, get the existing instance with SpringPlot.instance!');
            }
        }
        ...
        submit_new_SPRINGplot() {
            ...
            $.ajax({
                data: {
                    ...
                    current_dir: main_1.sub_directory,
                ...
                success: success_message => {
                    ...
                    if (running_online) {
                        ...
                        d3.select('#make_new_SPRINGplot_message_div')
                            ...
                            .html(orig_message);
                        function checkLog() {
                            jQuery.get(main_1.graph_directory + '/' + new_dir + '/lognewspring2.txt', logdata => {

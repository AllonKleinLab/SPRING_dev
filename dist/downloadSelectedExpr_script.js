define(["require", "exports", "d3", "./main"], function (require, exports, d3, main_1) {
    ...
    class DownloadSelectedExpr {
        constructor() {
            this.show_downloadSelectedExpr_popup = () => {
            ...
            d3.select('#downloadSelectedExpr_popup').call(d3
                .drag()
        ...
        static create(project_directory, color_menu_genes) {
            if (!this._instance) {
                ...
                throw new Error('DownloadSelectedExpr.create() has already been called, get the existing instance with DownloadSelectedExpr.instance!');
            }
        }
        ...
        downloadSelectedExpr() {
            ...
            $.ajax({
                data: {
                    ...
                    current_dir: main_1.graph_directory + '/' + main_1.sub_directory,
                    email: user_email,
    ...
    exports.default = DownloadSelectedExpr;
});

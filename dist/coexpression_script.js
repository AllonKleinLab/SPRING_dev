define(["require", "exports", "d3", "spinner", "./util"], function (require, exports, d3, Spinner, util_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.coexpression_setup = project_directory => {
        ...
        function refresh_selected_clusters() {
            ...
            exports.make_coexpression_spinner('coexpression_infobox');
            d3.select('#coexpression_infobox')
                .append('text')
        ...
        function load_cluster_expression(list, lengths_list, expression_dict) {
            ...
            d3.text(project_directory + '/cluster_expression/' + name + '.csv').then(text => {
                let tmp_expression_dict = util_1.read_csv(text);
        ...
        function scatter_setup(lengths_list, expression_dict) {
            ...
            let r = exports.pearsonCorrelation(xx, yy)
                .toString()
                .slice(0, 3);
    ...
    exports.make_coexpression_spinner = element => {
        let opts = {
            className: 'coexpression_spinner',
            color: 'gray',
            corners: 1,
            direction: 1,
            fps: 20,
    ...
    exports.pearsonCorrelation = (xx, yy) => {
